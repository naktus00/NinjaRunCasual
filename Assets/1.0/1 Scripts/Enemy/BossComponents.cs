...
public class BossComponents : MonoBehaviour
{
    ...
    [SerializeField] private GameObject _tenderSpot;
    ...
    [HideInInspector] public GameObject weapon { get { return _weapon; } }
    [HideInInspector] public GameObject tenderSpots { get { return _tenderSpot; } }
}
